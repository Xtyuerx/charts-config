...
export interface JsonURLConfig {
  lower_only_tooth_json: string;
  upper_only_tooth_json: string;
}
...
export interface AnalysisData {
  ...
  upper_midline_point?: ToothPoint | ToothPoint[]; // 上颌中线点位（单个或数组）
  lower_midline_point?: ToothPoint | ToothPoint[]; // 下颌中线点位（单个或数组）
